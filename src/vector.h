...
const TYPE *vector_##TYPE##_read_p(const vector_##TYPE##_t *self, size_t index);
...
u32 vector_##TYPE##_capacity(const vector_##TYPE##_t *self) { return self->capacity - self->start; }

u32 vector_##TYPE##_length(const vector_##TYPE##_t *self) 	{ return self->end - self->start; }
...
const vector_##TYPE##_t *vector_##TYPE##_copy_ro(const vector_##TYPE##_t *self) {
	vector_##TYPE##_t *new_vector = (vector_##TYPE##_t *)malloc(sizeof(vector_##TYPE##_t));
	new_vector->capacity = self->capacity;
	new_vector->start = self->start;
	new_vector->end = self->end;
...
const TYPE *vector_##TYPE##_read_p(const vector_##TYPE##_t *self, size_t index) { return self->start + index; }
