...
\
	size_t vector_##NAME##_capacity(const vector_##NAME *self) { return self->capacity - self->start; } \
	size_t vector_##NAME##_length(const vector_##NAME *self) { return self->end - self->start; } 		\
	size_t vector_##NAME##_size(const vector_##NAME *self) { return self->end - self->start; } 			\
\
	vector_##NAME* vector_##NAME##_move_h(vector_##NAME *self) { 						\
		vector_##NAME *new_vector = (vector_##NAME *)malloc(sizeof(vector_##NAME)); \
...
\
	vector_##NAME* vector_##NAME##_copy_h(const vector_##NAME *self) { 					\
		...
		memcpy(new_vector->start, self->start, vector_##NAME##_capacity(self) * sizeof(TYPE)); 	\
...
\
	TYPE *vector_##NAME##_get(vector_##NAME *self, size_t index) { return self->start + index; } 			\
	TYPE vector_##NAME##_read(const vector_##NAME *self, size_t index) { return *(self->start + index); } 	\
\
\
	void vector_##NAME##_swap(vector_##NAME *self, size_t index1, size_t index2) {	\
